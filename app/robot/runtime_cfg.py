...
TUNABLES: Dict[str, Dict[str, Any]] = {
    ...
    "obstacle_wait_before_replan_s": {
        ...
        "label":   "Replan wait",
        "unit":    "s",
        "description": "Seconds to wait for obstacle to move before forcing a replan (5s recommended)",
    },
    "nav_replan_seconds": {
        ...
        "unit":    "s",
        "description": "How often path replans during navigation",
    },
    "lidar_icp_weight": {
        ...
        "label":   "ICP weight",
        "unit":    "",
        "description": "Sensor fusion: 0=odometry only, 1=LiDAR only, 0.5=blend both",
    },
}
