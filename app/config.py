...
WAYPOINT_REACHED_M = 0.15
GOAL_TOLERANCE_M = 0.20
HEADING_TOLERANCE_RAD = 0.25
PATH_LOOKAHEAD_M = 0.30
NAV_LINEAR_GAIN = 0.90
NAV_ANGULAR_GAIN = 1.80
ROTATE_IN_PLACE_THRESHOLD_RAD = 1.0

NAV_MAX_ACCELERATION = 0.3
NAV_MAX_ANGULAR_ACCEL = 2.0
TRAJECTORY_LOOKAHEAD_M = 0.5
...
KD_ANGULAR = 0.3
KP_LINEAR = 1.0
PATH_SMOOTHING_RESOLUTION = 0.05
